...
public class SmsController {
    ...
    public Map sendSms(String phone, String code) throws ClientException {
        ...
        String sign_name = "大黑马";
        String template_code = "SMS_152541169";

        String sendStr = "{\"code\":\""+code+"\"}";

        System.out.println("======"+phone+"|"+sign_name+"|"+template_code+"|"+sendStr);
        ...
        request.setTemplateParam(sendStr);
